...
def client_optimizer_fn():
    return tf.keras.optimizers.Adam(learning_rate=0.001)  # 使用 Adam 优化器

def server_optimizer_fn():
    return tf.keras.optimizers.Adam(learning_rate=0.005)


aggregation_factory = tff.learning.model_update_aggregator.dp_aggregator(0.05,10)
